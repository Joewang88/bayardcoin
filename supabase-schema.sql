-- BayardCoin V5 Pro Supabase setup
...
-- Storage setup:
-- Dashboard > Storage > Create bucket > name: product-images > Public bucket: ON
-- Then Storage > Policies > product-images:
--   Allow public SELECT/read
--   Allow authenticated INSERT/UPDATE/DELETE

-- Optional automatic bucket/policy setup. If it errors in your project, create the bucket manually in Dashboard > Storage.
